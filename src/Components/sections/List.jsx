...
function List({ task, handleRemove, toggleComplete }) {
  return (
    <div className="shadow-lg md:shadow-none h-95 sm:h-120 md:h-150 w-[90%] sm:w-[70%] md:w-[50%] py-4 md:px-4 bg-[#fcf7df] text-[#3B2415] rounded-2xl md:rounded-none flex flex-col items-center gap-5 self-center md:self-start">
